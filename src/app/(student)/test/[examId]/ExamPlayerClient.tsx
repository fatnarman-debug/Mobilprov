...
export default function ExamPlayerClient({ mockExam, passingScore, siteName, userId, userLang }: ExamPlayerProps) {
  ...
  if (isSubmitted && results) {
    ...
    return (
      <div className="bg-background font-body-md text-on-background pb-4">
  ...
  return (
    <div className="bg-surface font-body-md text-on-surface pb-4">
      

      <main className="pt-6 px-4 md:px-8 max-w-[1600px] mx-auto w-full max-w-container-max mx-auto space-y-md">
